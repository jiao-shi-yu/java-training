...
public class HttpServletRequest {
    ...
    private String requestUri; // 请求的抽象路径
    private String queryString; // 查询的字符串

    private Map<String, String> parameters = new HashMap<>(); // 记录每一组参数 <参数名,参数值>
    ...
    private void parseURI() {
        // /myweb/reg?username=zhangsan&password=123456
        ...
        if (data.length > 1) {
            ...
            for (String para : paraArray) {
                ...
                if (paraPair.length > 1) {
                    ...
                    parameters.put(paraPair[0], null);
                }
            }
        }
